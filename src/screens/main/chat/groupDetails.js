...
export default class GroupDetails extends Component {
  ...
  constructor(props) {
    ...
    const isNeedFetchUsers = this.props.route?.params?.isNeed || this.props.route?.params?.tchUses
    this.state = {
      isPickImage: null,
  ...
  goToContactDeteailsScreen = (dialog) => {
    const { navigation } = this.props
    navigation.navigate('ContactDetails', { dialog })
  }
  ...
  goToContactsScreen = () => {
    ...
    const { navigation } = this.props
    const dialog = this.props.route?.params?.dialog || false
    navigation.navigate('Contacts', { isGroupDetails: true, dialog, addParticipant: this.addParticipant })
  }
    ...
    return this.isGroupCreator() ?
      (
        <TouchableOpacity style={styles.renderHeaderContainer} onPress={this.goToContactsScreen}>
          ...
          <View>
            <Text style={styles.nameTitle}>Ajouter</Text>
          </View>
        </TouchableOpacity>
      ) : false
  }
  ...
  _renderFlatListFooter = () => {
    return <TouchableOpacity style={styles.renderHeaderContainer} onPress={this.leaveGroup}>
      ...
      <View>
        <Text style={styles.nameTitle}>Quitter ce groupe</Text>
      </View>
    </TouchableOpacity>
  }
        ...
        {this.isGroupCreator() ?
          (<View>
            ...
            <View style={styles.subtitleWrap}>
              <Text style={styles.subtitleInpu}>Changer</Text>
            </View>
          </View>) :
